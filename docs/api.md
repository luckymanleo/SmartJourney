...
**Request:** `{ "title": "...", "origin": "深圳", "destination": "武夷山", "start_date": "2026-06-13", "end_date": "2026-06-15", "traveler_count": 2, "budget_total": 3000 }`
...
**Request:** `{ "day_id": "...", "type": "train", "title": "D2325 武夷山北→深圳北", "start_time": "08:24", "end_time": "15:38", "price": 320, "booking_url": "https://..." }`
...
```
GET /api/v1/info/weather?city=武夷山&days=7
Authorization: Bearer <token>
```
