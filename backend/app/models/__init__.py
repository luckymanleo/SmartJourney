...
class TripItem(Base):
    ...
    start_time: Mapped[str | None] = mapped_column(String(5), nullable=True, comment="开始时间 HH:MM")
    end_time: Mapped[str | None] = mapped_column(String(5), nullable=True, comment="结束时间 HH:MM")
